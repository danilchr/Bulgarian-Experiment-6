...
var example_index_incremented_by_one;
...
//Sequence("finished");
Sequence("mobile_device_check","intro1",  "demo", "trials",  "demo_all", "expbegin", randomize("experiment"), "Sync", SendResults(), "bye");
//Sequence("mobile_device_check","intro1", "trials",  "demo_all", "expbegin", randomize("experiment"), SendResults(), "bye");
...
newTrial("intro1",
    ...
    newText("Ще ви бъдат представени писмено недовършени изречения, в които думите се появяват една след друга. Вашата задача е да ги довършите, като поставите последната дума в подходящата форма. Ще видите всяко изречение само веднъж и няма да можете да се върнете назад. Отговорите се появяват на един ред по следния начин:<pre>стол&#9&#9столове&#9&#9стола</pre>За да отговорите на въпроса, моля, натиснете цифров клавиш 1, 2 или 3 на клавиатурата, който съответства на избрания отговор. Ако отговорът Ви се намира най-вляво, натиснете 1, в средата – натиснете 2, вдясно – натиснете 3:<pre>стол (1)&#9&#9столове (2)&#9&#9стола (3)</pre>Ако има само два отговора, натиснете 1 (за отговор вляво) или 2 (за отговор вдясно):<pre>маса (1)&#9&#9маси (2)</pre>")
    .css("width","40em")
    .css("line-height","1.4")
    //.css("padding-top","40px")
    .css("padding-bottom","20px")
    ...
    newText("Моля, не прекъсвайте експеримента, докато четете изреченията и отговаряте на въпросите. Ако имате желание да си починете, го направете преди да преминете към следващия пример.")
    .css("width","40em")
    .css("line-height","1.4")
    //.css("padding-top","40px")
    .css("padding-bottom","20px")
...
//Template("test_csv",
 ...
 newText("Пример "+parseInt(variable.Index)+":")
    ...
    example_index=variable.Index
    ,
    example_index_incremented_by_one=parseInt(example_index)+1
    ,
    
    (parseInt(example_index)==1?
    
    [
    
    
     newButton("continue_with_next_sentence", "Продължете с пример "+example_index_incremented_by_one+", като натиснете този бутон или клавиша за разстояние на клавиатурата")
          .color("red")
          .print()
          .center()
          //.wait()
   ...
   ,
    ...
    [
         ...
         newButton("continue_with_next_sentence", "Продължете с експеримента, като натиснете този бутон или клавиша за разстояние на клавиатурата")
          .color("red")
          .print()
          .center()
          //.wait()
...
//newController("myController","Question", {q: Question_asked, as: ["престъпник","престъпници","престъпника"],randomOrder:true,hasCorrect: parseInt("2")})  
    .css("width","40em")
    .css("line-height","1.4")
    //.css("padding-top","40px")
    .css("padding-bottom","20px")
 ...
 newText("Пример 2:")
   ...
   ,
    ...
    ,    
        ...
        //newController("myController","Question", {q: Question_asked, as: ["изпълнителка","изпълнителки"],randomOrder:true,hasCorrect: parseInt("1")})    
            .css("width","40em")
            .css("line-height","1.4")
            //.css("padding-top","40px")
            .css("padding-bottom","20px")
...
//Template("test_csv",
    ...
    newText(variable.Final_sentence)
    //.print()
    ,
    
    newText(variable.Target_noun_base_form)
    //.print()
    ,
        ...
        Question_asked =Question_asked1
        ,       
        newController("myController","Question", {q: "", as: [variable.Target_noun_plural_form,variable.Target_noun_count_form],randomOrder:true, hasCorrect: parseInt(variable.Correct_response_as_integer)})
        //newController("Question", {q: "Моля довършете изречението, като поставете последната дума в подходящата форма чрез натискане с мишката върху съответната форма", as: [variable.Target_noun_base_form,variable.Target_noun_plural_form,variable.Target_noun_count_form],randomOrder:false,presentHorizontally:true, hasCorrect: parseInt(variable.Correct_respo_as_integer)})
            .css("width","40em")
            .css("line-height","1.4")
            //.css("padding-top","40px")
...
.log("Condition label for group assignment",variable.Condition_label_for_group_assignment)
...
.log("Number of intervening noun singular or plural",variable.Number_of_intervening_noun_singular_or_plural)
.log("Number of intervening noun singular plural or count",variable.Number_of_intervening_noun_singular_plural_or_count)
.log("Gender of target noun",variable.Gender_of_target_noun)
.log("Number of target noun singular or plural",variable.Number_of_target_noun_singular_or_plural)
.log("Number of target noun singular plural or count",variable.Number_of_target_noun_singular_plural_or_count)
.log("Beginning",variable.Beginning)
.log("First Numeral",variable.First_Numeral)
...
.log("Adjective marker if not present",variable.Adjective_marker_if_not_present)
.log("Adjective if used",variable.Adjective_if_used)
.log("Second numeral",variable.Second_numeral)
.log("Second numeral if present",variable.Second_numeral_if_present)
