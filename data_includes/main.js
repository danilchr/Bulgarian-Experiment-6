...
newTrial ("demo1",
 ...
 newText("Пример 1:")
   ...
   //,
    ...
    ,
         newController("DashedSentence", {s: "Вчера стопанинът обязди няколко млади черни",mode:"speeded acceptability", display: "in place",wordTime:600,wordPauseTime:0, hideUnderscores: true})
 ...
 newText("Пример 2:")
   ...
   ,
     ...
     newText("")
      ...
      .print()
    ,    
         newController("DashedSentence", {s: "Вчера стопанката нахрани няколко стари бели",mode:"speeded acceptability", display: "in place",wordTime:600,wordPauseTime:0, hideUnderscores: true})
        //newController("DashedSentence", {s: "<p style=\"font-size:18pt\">"+variable.Final_sentence+"</p>", display: "in place", hideUnderscores: true})
        //newController("DashedSentence", {s: variable.Final_sentence+"</p>", display: "in place", hideUnderscores: true,html
            .css("font-size","18pt")
            .center()
     ...
     newText("")
      ...
      ,
        ...
        //getVar("RT",set(a=>Date.now()-a))
         ...
         newController("DashedSentence", {s: variable.Final_sentence,mode:"speeded acceptability", display: "in place",wordTime:600,wordPauseTime:0, hideUnderscores: true})
        //newController("DashedSentence", {s: "<p style=\"font-size:18pt\">"+variable.Final_sentence+"</p>", display: "in place", hideUnderscores: true})
        //newController("DashedSentence", {s: variable.Final_sentence+"</p>", display: "in place", hideUnderscores: true,html
            .css("font-size","18pt")
            .center()
