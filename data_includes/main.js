 ...
 newText("Пример 2:")
   ...
   ,
    ...
    ,    
        ...
        newController("Question", {q: Question_asked, as: ["крава","крави"],randomOrder:['v','b'],presentHorizontally:true, hasCorrect: parseInt("1")})
            .css("width","40em")
            .css("line-height","1.4")
            //.css("padding-top","40px")
            .css("padding-bottom","20px")
    ...
    //item_index=item_index+1,
     ...
     newText("")
      ...
      ,
        ...
        newController("Question", {q: "", as: [variable.Target_noun_base_form,variable.Target_noun_plural_form,variable.Target_noun_count_form],randomOrder:['v','b','n'],presentHorizontally:true, hasCorrect: parseInt(variable.Correct_response_as_integer)})
        ...
        newController("Question", {q: "", as: [variable.Target_noun_base_form,variable.Target_noun_plural_form],randomOrder:['v','b'],presentHorizontally:true, hasCorrect: parseInt(variable.Correct_response_as_integer)})
            .center()
            .print()
            .log()
            .wait()
